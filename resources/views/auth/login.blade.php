        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="login-wrap p-0">
                    ...
                    @if ($errors->any())
                        <div class="alert alert-danger py-2" style="background: rgba(220, 53, 69, 0.2); border: 1px solid #dc3545; color: #fff; border-radius: 10px; font-size: 0.9rem;">
                            <ul class="mb-0 list-unstyled text-center">
                                @foreach ($errors->all() as $error)
                                    <li><i class="fa fa-exclamation-triangle mr-2"></i>{{ $error }}</li>
                                @endforeach
                            </ul>
                        </div>
                    @endif
